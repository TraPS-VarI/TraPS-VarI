...
Usage
*****
python TraPS VarI . py {−p=<CHR: POS> −m=<REF/ALT >| −f=<filename> [options]} [−assembly=<assemblyversion>]
...
The script will generate an outputfile namely traps_vari_output with the following appended columns:-
	
	1. Protein position, 
	2. Protein aminoacid change, 
	3. mutation effect,
	4. STAT3 binding motif alterations (namely, CREATED, DESTROYED or PRESENT), 
	5. Hits in the TTD database and 
	6. Hits in the DrugBank database.
...
significantly elevates the levels of tyrosine phosphorylation in STAT3 thereby enhancing the amplitude of STAT3 signaling. Depending on the expression patterns
of the receptor variant, pleiotropic effects are expected in vivo.
STAT3-enhancing gain-of-function SNPs in the germline genome also contributes to accelerated cancer progression & poor prognosis. However, cells are rendered sensitive in a 
